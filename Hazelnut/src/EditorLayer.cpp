...
namespace Hazel {
	...
	void EditorLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseButtonPressedEvent>(HZ_BIND_EVENT_FN(EditorLayer::OnMouseBottonPressed));
	}
	...
	bool EditorLayer::OnMouseBottonPressed(MouseButtonPressedEvent& e)
	{
